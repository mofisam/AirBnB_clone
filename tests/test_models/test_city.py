...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        """Test if the output of to_dict matches the expected dictionary."""
        cy = City()
        cy_dict = cy.to_dict()
    ...
    def test_to_dict_with_arg(self):
        """Test if to_dict raises an error when passed an argument."""
        cy = City()
        with self.assertRaises(TypeError):
            cy.to_dict(None)

    def test_contrast_to_dict_dunder_dict(self):
        """Test if the output of to_dict is different from __dict__."""
        cy = City()
